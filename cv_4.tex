...
\address{\href{http://www.public.asu.edu/~zfang29/}{{\color{blush} Website }}\ \hspace{.4cm} \href{mailto:zy.fang@asu.edu}{\color{blush}Email} \hspace{.4cm}  \href{https://scholar.google.com/citations?user=fHWXpq4AAAAJ} {\color{blush}Google Scholar}}
...
\vspace{-3mm}
\begin{tikzpicture}
\draw [dash pattern={on 7pt off 2pt on 1pt off 3pt}] (0,0) -- (16.3,0);
\end{tikzpicture}
\vspace{-3mm}
...
%   \item \href{}{ \textit{``Temporal
%     language grounding with referring attention and weak supervision.''}}{\textbf{{Zhiyuan Fang}}, Shu Kong, Zhe Wang, Charless Fowlkes, and Yezhou Yang, April, 2020 (arXiv:2006.11747)}
...
\itab{\textbf{Conference Reviewer:}} 
